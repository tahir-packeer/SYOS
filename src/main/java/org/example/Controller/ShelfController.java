...
public class ShelfController {
    ...
    public void add_items_to_shelf(Shelf shelf) throws SQLException, ClassNotFoundException
    {
    ...
    public int get_latest_added_shelf_id() throws SQLException, ClassNotFoundException {
        DatabaseConnection databaseConnection = new DatabaseConnection();
        Connection connection = databaseConnection.connect();
        PreparedStatement statement = null;
            ...
            throws SQLException, ClassNotFoundException
    {
        ...
        while (resultSet.next()) {
            ...
            Item self_item = new ItemController().getItem_from_Id(resultSet.getInt("item_id"));
            ...
            throws SQLException, ClassNotFoundException
    {
        ...
        try
        {
            ...
            while (stockResultSet.next() && quantityToAdd > 0) {
                ...
                String insertShelfStock = "INSERT INTO shelf_stock (shelf_id, stock_id) VALUES (?, ?)";
    ...
    public Shelf get_Shelf_By_Id(int shelfId) throws SQLException, ClassNotFoundException {
        ...
        if (resultSet.next()) {
            Item item = new ItemController().getItem_from_Id(resultSet.getInt("item_id"));
